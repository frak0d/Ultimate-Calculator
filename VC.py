...
def Cuboid():
	...
	print()
	print(' <======---====*-*====---======>')
	print(' Volume of Cuboid is',vcm,'cm³ or',vm,'m³')
	print(' <======---====*-*====---======>')
	print()
...
def Sphere() :
	...
	print()
	print(' <======---====*-*====---======>')
	print(' Volume of Sphere is',vcm,'cm³ or',vm,'m³')
	print(' <======---====*-*====---======>')
	print()
...
def Cone():
	...
	print()
	print(' <======---====*-*====---======>')
	print(' Volume of Cone is',vcm,'cm³ or',vm,'m³')
	print(' <======---====*-*====---======>')
	print()
...
def Volume():
	...
	print()
	print(' 1  ---->  Find Volume of Cube')
	print(' 2  ---->  Find Volume of Cuboid')
	print(' 3  ---->  Find Volume of Sphere')
	print(' 4  ---->  Find Volume of Cone')
	print()
	print(' <======---====*-*====---======>')
	print()
